    ...
    <>
      <header
        className={`sticky top-0 z-50 transition-all duration-slow ${
          scrolled
            ? 'bg-white/95 dark:bg-black/95 backdrop-blur-xl shadow-lg border-b border-gray-100 dark:border-white/10'
            : 'bg-white dark:bg-black border-b border-gray-200 dark:border-white/10 shadow-md'
        }`}
      >
